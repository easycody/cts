...
func NewClient(apikey string, secretKey string, msgType int) *BaiduPushClient {
...
//map key is appid,value is pushclient
var PushCache = make(map[string]*BaiduPushClient)
...
func (c *BaiduPushClient) MsgType() int {
	return c.msgType
}
